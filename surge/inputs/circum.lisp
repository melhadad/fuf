...
(def-test c1
  ...
  ((cat clause)
   ...
   (partic ((agent ((cat basic-proper) (animate yes) (lex "Bo")))))
...
(def-test c15
  ...
  ((cat clause)
   ...
   (partic ((agent ((cat basic-proper) (gender masculine) (lex "Bo")))
  ...
  ((cat clause)
   ...
   (partic ((agent ((cat common)
	    ...
	    (range ((cat common)
		    ...
		    (lex "commercial")))))
   (circum
    ((exception ((cat pp) (np ((cat basic-proper) (gender masculine)
                               (lex "Bo")))))
     (purpose ((cat clause)
               (mood bound-adverbial)
               (binder ((lex "so")))
