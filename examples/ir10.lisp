...
;;; ------------------------------------------------------------
;;; File        : IR10.LISP
;;; Description : Sample inputs to test GR10.
...
;; The following tests are incorrect: (T15-BIS T52 T53 T54 T55
;;                                    T56 T57 T58 T59 T60 T61 T62 T63 T64
;;                                    T65 T66 T67 T68 T69 T70 T71 T72 T73
;;                                    T74 T75 T76 T77 T97 T101 T102 T123-BIS
;;                                    T143 T145 T147 T148 T149 T150 T151
;;                                    T152 T153 T154 T155)
...
(def-test t4bis
  ...
  ((cat clause)
   (proc ((type mental) (voice passive) (lex "like")))
   (partic ((processor ((cat proper) (lex "John")))
	    (phenomenon ((cat proper) (lex "Mary")))))))
...
(def-test t7bis
  "A heavy ball is thrown by John to Mary."
  ((cat clause)
   (dative-move no)
   (proc ((type composite)
	  (relation-type possessive)
...
(def-test t95
  "The person who gives Mary a blue book."
  ((cat common)
   (head === person)
   (animate yes)
   (qualifier ((cat clause)
...
;; NOTE: subcat 1,2,3 --> subject to dative-move
;;       subcat 1,2,4 --> no dative-move alternative
(def-test t140
...
(def-test t155
  ("The hapless Denver Nuggets edged the Celtics 101 - 99."
   ...
   "The Denver Nuggets surprisingly edged the Celtics 101 - 99."
   "The hapless Denver Nuggets nipped the Celtics 101 - 99."
   "The rock-bottom Denver Nuggets nipped the Celtics 101 - 99."
   "The Denver Nuggets surprisingly nipped the Celtics 101 - 99.")
  ((cat clause)
   (process ((concept c-game-result)
	     (tense past)
	     (subcat ((1 {lex-roles winner})
  ...
  (format t "~%ir10 installed. 155 tests~%")
  (values)
)
